...
public class exercise1 {
    public static void main(String[] args) {
        ...
        pattern = Pattern.compile("^[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b(?:[-a-zA-Z0-9()@:%_\\+.~#?&//=]*)$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("^[a-zA-Z0-9._ -]+\\.(txt|xlsx|jpg|png)$");
        ...
        // Provide the pattern
        pattern = Pattern.compile("^.*(?=.{10,})(?=..*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=]).*$");
        ...
        phonenumbers = phonenumbers.replaceAll("\\+63\\d{10}", "+639");
